        ...
        {props.quote && (
            <div className="quote-display animated fadeIn">
                <div className="quote-display-quote">
                    <i className="fa fa-quote-left fa-lg quote-display-quotes" />
                    ...
                    <i className="fa fa-quote-right fa-lg quote-display-quotes" />
                </div>
                ...
                >
                    <i className="fa fa-circle fa-stack-2x button-icon" />
                    <i className="fa fa-heart fa-stack-1x fa-inverse" />
                </span>
