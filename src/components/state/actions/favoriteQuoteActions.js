...
export const ADD_TO_FAVORITE_QUOTES_FULFILLED =
  'ADD_TO_FAVORITE_QUOTES_FULFILLED';
export const ADD_TO_FAVORITE_QUOTES_REJECTED =
...
export const FETCH_FAVORITE_QUOTES_FULFILLED =
...
export const REMOVE_FAVORITE_QUOTE_FULFILLED =
